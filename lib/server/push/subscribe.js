...
function toRecord(body = {}) {
  return {
    ...
    // Rôle RACI de l'appareil : permet le ciblage des notifications par rôle
    // (promotrice_direction, responsable_filiere, terrain, veterinaire, finance,
    // admin_support). Optionnel : sans rôle, l'appareil reçoit tout (repli).
    role: body.role || body.raci_role || '',
