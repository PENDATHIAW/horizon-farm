...
export default function App() {
  ...
  const moduleProps = {
    ...
    finances: { rows: financesCrud.rows, loading: financesCrud.loading, onCreate: financesCrud.create, onUpdate: financesCrud.update, onDelete: financesCrud.remove, onRefresh: financesCrud.refresh, animaux: animauxCrud.rows, lots: avicoleCrud.rows, cultures: culturesCrud.rows, stocks: stockCrud.rows, investissements: investissementsCrud.rows, clients: clientsCrud.rows, fournisseurs: fournisseursCrud.rows, alimentationLogs: alimentationLogsCrud.rows, businessPlans: businessPlansCrud.rows, salesOrders: salesOrdersCrud.rows, payments: paymentsCrud.rows, onNavigate: setActive },
