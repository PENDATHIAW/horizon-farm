...
const MODULES = {
  ...
  sante: lazy(() => import('./modules/SanteV4')),
  ...
  stock: lazy(() => import('./modules/StocksV2')),
  ...
  cultures: lazy(() => import('./modules/CulturesV2')),
