...
export default function App() {
  ...
  const navItems = useMemo(
    () => [
      ...
      { id: 'investissements', label: 'Investissements', icon: TrendingUp },
      {
        ...
        label: 'Impact & Valeur',
        icon: TrendingUp,
        hasAlert: vaccinsRetard > 0 || stocksCritiques > 0 || animauxMalades > 0 || lotsAlerte > 0,
      },
      ...
      { id: 'tracabilite', label: 'Traçabilité', icon: GitBranch },
      {
        ...
        label: 'Alertes',
        icon: History,
        hasAlert: (dataMap.alertes_center || []).filter((a) => a.status === 'nouvelle').length > 0,
      },
  ...
  const reportData = {
    ...
    clients: clientsCrud.rows,
    fournisseurs: fournisseursCrud.rows,
    taches: tachesCrud.rows,
    alertes: alertesCenterCrud.rows,
    equipements: equipementsCrud.rows,
  };
  ...
  const syncActivityProps = {
    ...
    lastOnlineAt,
    dataMap,
    auditLogs: auditLogsCrud.rows,
    auditLoading: auditLogsCrud.loading,
    onRefreshAuditLogs: auditLogsCrud.refresh,
    onNavigate: setActive,
    onCreateTask: tachesCrud.create,
    onRefreshTasks: tachesCrud.refresh,
    onCreateAlert: alertesCenterCrud.create,
    onRefreshAlertes: alertesCenterCrud.refresh,
    onUpdateSalesOrder: salesOrdersCrud.update,
    onRefreshSalesOrders: salesOrdersCrud.refresh,
    onUpdateOpportunity: salesOpportunitiesCrud.update,
    onRefreshOpportunities: salesOpportunitiesCrud.refresh,
    onCreateDocument: documentsCrud.create,
    onRefreshDocuments: documentsCrud.refresh,
    onCreateBusinessEvent: businessEventsCrud.create,
    onRefreshBusinessEvents: businessEventsCrud.refresh,
  };
  ...
  const moduleProps = {
    ...
    animaux: {
      rows: animauxCrud.rows,
      alimentationLogs: alimentationLogsCrud.rows,
      vaccins: santeCrud.rows,
      opportunities: salesOpportunitiesCrud.rows,
      loading: animauxCrud.loading,
      onCreate: animauxCrud.create,
      onUpdate: animauxCrud.update,
      onDelete: animauxCrud.remove,
      onRefresh: animauxCrud.refresh,
    ...
    investissements: {
      ...
      onCreateFinanceTransaction: financesCrud.create,
      onRefreshFinances: financesCrud.refresh,
      onCreateLot: avicoleCrud.create,
      onRefreshLots: avicoleCrud.refresh,
      onCreateAnimal: animauxCrud.create,
      onRefreshAnimals: animauxCrud.refresh,
      onCreateCulture: culturesCrud.create,
      onRefreshCultures: culturesCrud.refresh,
    },
    impact_business: {
      animaux: animauxCrud.rows,
      lots: avicoleCrud.rows,
    ...
    stock: {
      ...
      onRefreshOpportunities: salesOpportunitiesCrud.refresh,
      onCreateTask: tachesCrud.create,
      onUpdateTask: tachesCrud.update,
      onRefreshTasks: tachesCrud.refresh,
      onCreateAlert: alertesCenterCrud.create,
      onRefreshAlertes: alertesCenterCrud.refresh,
      onCreateBusinessEvent: businessEventsCrud.create,
    ...
    clients: {
      rows: clientsCrud.rows,
      loading: clientsCrud.loading,
      salesOrders: salesOrdersCrud.rows,
      payments: paymentsCrud.rows,
      transactions: financesCrud.rows,
      onCreate: clientsCrud.create,
      onUpdate: clientsCrud.update,
      onDelete: clientsCrud.remove,
      onRefresh: clientsCrud.refresh,
    },
    fournisseurs: {
      rows: fournisseursCrud.rows,
      stocks: stockCrud.rows,
      tasks: tachesCrud.rows,
      transactions: financesCrud.rows,
      finances: financesCrud.rows,
      documents: documentsCrud.rows,
      loading: fournisseursCrud.loading,
      onCreate: fournisseursCrud.create,
      onUpdate: fournisseursCrud.update,
      onDelete: fournisseursCrud.remove,
      onRefresh: fournisseursCrud.refresh,
      onUpdateStock: stockCrud.update,
      onRefreshStock: stockCrud.refresh,
      onCreateTask: tachesCrud.create,
      onRefreshTasks: tachesCrud.refresh,
      onCreateAlert: alertesCenterCrud.create,
      onRefreshAlertes: alertesCenterCrud.refresh,
    ...
    cultures: {
      rows: culturesCrud.rows,
      transactions: financesCrud.rows,
      opportunities: salesOpportunitiesCrud.rows,
      loading: culturesCrud.loading,
      onCreate: culturesCrud.create,
      onUpdate: culturesCrud.update,
      onDelete: culturesCrud.remove,
      onRefresh: culturesCrud.refresh,
      onCreateOpportunity: salesOpportunitiesCrud.create,
      onUpdateOpportunity: salesOpportunitiesCrud.update,
      onRefreshOpportunities: salesOpportunitiesCrud.refresh,
      onCreateBusinessEvent: businessEventsCrud.create,
    ...
    ventes: {
      ...
      onRefreshWorkflow: refreshSalesWorkflow,
      onRefreshOpportunities: salesOpportunitiesCrud.refresh,
      ...
      onRefreshCultures: culturesCrud.refresh,
      onUpdateStock: stockCrud.update,
      onRefreshStocks: stockCrud.refresh,
      onCreateFinanceTransaction: financesCrud.create,
      onRefreshFinances: financesCrud.refresh,
    ...
    taches: {
      rows: tachesCrud.rows,
      alertes: alertesCenterCrud.rows,
      loading: tachesCrud.loading,
      onCreate: tachesCrud.create,
      onUpdate: tachesCrud.update,
      onDelete: tachesCrud.remove,
      onRefresh: tachesCrud.refresh,
      onUpdateAlert: alertesCenterCrud.update,
      onRefreshAlertes: alertesCenterCrud.refresh,
      onCreateBusinessEvent: businessEventsCrud.create,
      onRefreshBusinessEvents: businessEventsCrud.refresh,
    },
    ...
    rapports: {
      rows: rapportsCrud.rows,
      data: reportData,
      loading: rapportsCrud.loading,
      onCreate: rapportsCrud.create,
      onUpdate: rapportsCrud.update,
      onDelete: rapportsCrud.remove,
      onRefresh: rapportsCrud.refresh,
      onCreateDocument: documentsCrud.create,
      onRefreshDocuments: documentsCrud.refresh,
      onCreateBusinessEvent: businessEventsCrud.create,
      onRefreshBusinessEvents: businessEventsCrud.refresh,
    ...
    equipements: {
      rows: equipementsCrud.rows,
      tasks: tachesCrud.rows,
      loading: equipementsCrud.loading,
      onCreate: equipementsCrud.create,
      onUpdate: equipementsCrud.update,
      onDelete: equipementsCrud.remove,
      onRefresh: equipementsCrud.refresh,
      onCreateTask: tachesCrud.create,
      onUpdateTask: tachesCrud.update,
      onRefreshTasks: tachesCrud.refresh,
      onCreateAlert: alertesCenterCrud.create,
  ...
  return (
    ...
    >
      <AppNotificationManager dataMap={dataMap} onNavigate={setActive} />
