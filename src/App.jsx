...
export default function App() {
  ...
  const [agriFeedsTab, setAgriFeedsTab] = useState('Vue d’ensemble');
  ...
  const [gestionSystemeTab, setGestionSystemeTab] = useState('Fermes');
  ...
  const navigateModule = useCallback((moduleId, options = {}) => {
    ...
    if (resolved === 'agri_feeds') {
      setAgriFeedsTab(resolveAgriFeedsTab(tab || 'Vue d’ensemble'));
