...
export default function App() {
  ...
  const navigateModule = useCallback((moduleId, options = {}) => {
    ...
    if (resolved === 'investisseurs_forums') {
      if (tab) setInvestisseursTab(tab);
