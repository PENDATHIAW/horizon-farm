...
export default function App() {
  ...
  const navItems = useMemo(() => [
    ...
    { id: 'centre_ia', label: 'Centre décisionnel', icon: TrendingUp, hasAlert: stocksCritiques > 0 || lotsAlerte > 0 || financesAlerte > 0 || culturesRisque > 0 },
    { id: 'objectifs_croissance', label: 'Objectifs & Croissance', icon: TrendingUp, hasAlert: financesAlerte > 0 || lotsAlerte > 0 || culturesRisque > 0 },
