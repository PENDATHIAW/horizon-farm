...
const MODULES = {
  ...
  comptabilite: lazy(() => import('./modules/ComptabiliteV3')),
...
export default function App() {
  ...
  const moduleProps = {
    ...
    comptabilite: { transactions: financesCrud.rows, finances: financesCrud.rows, clients: clientsCrud.rows, fournisseurs: fournisseursCrud.rows, stocks: stockCrud.rows, animaux: animauxCrud.rows, lots: avicoleCrud.rows, cultures: culturesCrud.rows, sante: santeCrud.rows, investissements: investissementsCrud.rows, equipements: equipementsCrud.rows, onRefreshFinances: financesCrud.refresh, onNavigate: setActive },
