...
const MODULES = {
  ...
  comptabilite: lazy(() => import('./modules/ComptabiliteV2')),
...
export default function App() {
  ...
  const moduleProps = {
    ...
    comptabilite: { transactions: financesCrud.rows, clients: clientsCrud.rows, fournisseurs: fournisseursCrud.rows, onRefreshFinances: financesCrud.refresh, onNavigate: setActive },
