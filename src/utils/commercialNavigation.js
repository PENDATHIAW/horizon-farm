...
export const CENTRE_IA_TABS = ['À traiter', 'Écarts', 'Risques', 'Décisions', 'Historique'];
...
export const DASHBOARD_TABS = ['Vue du jour', 'Pilotage', 'Mes actions'];
export const DASHBOARD_TAB_ALIASES = {
  ...
  'mes actions': 'Mes actions',
  'Carnet Horizon': 'Vue du jour',
  Carnet: 'Vue du jour',
  Résumé: 'Vue du jour',
  resume: 'Vue du jour',
  'Priorités du jour': 'Vue du jour',
  Graphiques: 'Pilotage',
  graphiques: 'Pilotage',
  'Indicateurs ferme': 'Pilotage',
  'Vue financeur rapide': 'Pilotage',
  taches: 'Mes actions',
  Tâches: 'Mes actions',
};
