...
const PILOTAGE_ROUTES = {
  ...
  alert: { module: 'centre_ia', tab: 'Risques', label: 'Risques' },
  ...
  smart: { module: 'centre_ia', tab: 'À traiter', label: 'Priorités IA' },
  sync: { module: 'centre_ia', tab: 'Risques', label: 'Risques' },
};
