...
export const COMMERCIAL_HEY_HORIZON_QUESTIONS = [
  { id: 'relance_today', label: 'Clients à relancer', query: 'Quels clients dois-je relancer aujourd\'hui ?', moduleId: 'commercial', tab: 'Clients & créances' },
  ...
  { id: 'top_clients', label: 'Top clients', query: 'Quels clients achètent le plus ?', moduleId: 'commercial', tab: 'Clients & créances' },
  { id: 'top_products', label: 'Top produits', query: 'Quels produits se vendent le mieux ?', moduleId: 'commercial', tab: 'Pilotage' },
  { id: 'farm_sales', label: 'Ventes par ferme', query: 'Quelle ferme vend le plus ?', moduleId: 'commercial', tab: 'Pilotage' },
  { id: 'segment_ca', label: 'Segment le plus rentable', query: 'Quel segment client rapporte le plus ?', moduleId: 'commercial', tab: 'Clients & créances' },
  ...
  { id: 'receivables', label: 'Créances', query: 'Quelles créances sont ouvertes ?', moduleId: 'commercial', tab: 'Clients & créances' },
];
