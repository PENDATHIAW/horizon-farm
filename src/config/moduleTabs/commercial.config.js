...
export default defineModuleTabs('commercial', labels.commercial, [
  ...
  { id: 'ventes-commandes', component: 'Ventes & commandes commercial', aliases: ['Ventes', 'Devis'] },
  { id: 'opportunites', component: 'Opportunités commercial', aliases: ['Opportunités', 'Opportunites', 'Opportunité'] },
