...
export const MODULE_TARGET_TABS = {
  ...
  investisseurs_forums: ['Vue financeur', 'Utilisation financement', 'Rapports', 'Preuves', 'Suivi des engagements'],
...
export const INTERCONNECTIONS = {
  ...
  tresorerie: ['finance_pilotage', 'commercial', 'achats_stock', 'objectifs_croissance', 'investisseurs_forums', 'centre_ia'],
  dossier_financeur: ['finance_pilotage', 'documents_rapports', 'objectifs_croissance', 'investisseurs_forums', 'centre_ia'],
