...
export const MODULE_TARGET_TABS = {
  ...
  centre_decisionnel: ['Urgences & risques', 'Croissance & opportunités', 'Saisons & marchés'],
  ...
  equipe: ['Cockpit RH & Maintenance', 'Personnel & Paie', 'Parc Matériel & Maintenance', 'Registres & Analyses'],
...
export const INTERCONNECTIONS = {
  ...BUSINESS_EVENT_INTERCONNECTIONS,
  vente: ['commercial', 'achats_stock', 'finance_pilotage', 'clients', 'documents_rapports', 'centre_decisionnel'],
  creance_client: ['commercial', 'finance_pilotage', 'activite_suivi', 'documents_rapports', 'centre_decisionnel'],
  achat: ['achats_stock', 'finance_pilotage', 'fournisseurs', 'documents_rapports', 'centre_decisionnel'],
  stock_rupture: ['achats_stock', 'elevage', 'cultures', 'commercial', 'finance_pilotage', 'centre_decisionnel'],
  mortalite: ['elevage', 'finance_pilotage', 'activite_suivi', 'centre_decisionnel', 'documents_rapports'],
  ponte: ['elevage', 'achats_stock', 'commercial', 'finance_pilotage', 'centre_decisionnel'],
  recolte_culture: ['cultures', 'achats_stock', 'commercial', 'finance_pilotage', 'documents_rapports'],
  effluents: ['elevage', 'achats_stock', 'cultures', 'finance_pilotage', 'documents_rapports', 'centre_decisionnel'],
  biosécurité: ['elevage', 'achats_stock', 'cultures', 'activite_suivi', 'finance_pilotage', 'centre_decisionnel'],
  tresorerie: ['finance_pilotage', 'commercial', 'achats_stock', 'objectifs_croissance', 'financements', 'centre_decisionnel'],
  dossier_financeur: ['finance_pilotage', 'documents_rapports', 'objectifs_croissance', 'financements', 'centre_decisionnel'],
  donnees_iot: ['smartfarm', 'cultures', 'elevage', 'equipements', 'activite_suivi', 'centre_decisionnel'],
  agri_feeds_reference: ['agri_feeds', 'elevage', 'achats_stock', 'finance_pilotage', 'centre_decisionnel'],
  agri_feeds_production: ['agri_feeds', 'achats_stock', 'elevage', 'finance_pilotage', 'activite_suivi', 'centre_decisionnel'],
  agri_feeds_trial: ['agri_feeds', 'elevage', 'objectifs_croissance', 'centre_decisionnel', 'activite_suivi'],
  agri_feeds_sale: ['agri_feeds', 'commercial', 'finance_pilotage', 'achats_stock', 'centre_decisionnel'],
  future_extension_decision: ['centre_decisionnel', 'agri_feeds', 'elevage', 'achats_stock', 'finance_pilotage', 'documents_rapports'],
};
