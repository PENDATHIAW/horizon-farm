...
export const MODULE_TARGET_TABS = {
  ...
  objectifs_croissance: ['Rentabilité Lot & Cycle', 'Efficacité Technique', 'Flux & Équilibres', 'Maraîchage & Diversification', 'Graphiques', 'Annexe'],
  centre_ia: ['À traiter', 'Recommandations', 'Cycles', 'Risques', 'Historique', 'Graphiques', 'Annexe'],
