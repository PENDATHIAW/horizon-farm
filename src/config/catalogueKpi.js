...
export const CATALOGUE_KPI = Object.freeze({
  ...
  marge_globale: kpi({ code: 'marge_globale', libelle: 'Marge globale', unite: 'FCFA', periodeParDefaut: 'à date', proprietaire: 'finance_pilotage', sourceLabel: 'kpiEngine.finance', sourceDisponible: disponible('finances', 'transactions', 'payments'), calcul: (moteur) => nombre(moteur?.finance?.margeReelle ?? moteur?.finance?.grossMargin) }),
