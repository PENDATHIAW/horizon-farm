...
export const AGRI_FEEDS_TAB_ALIASES = Object.freeze({
  ...
  reference: 'Référence Phase 1',
  phase1: 'Référence Phase 1',
  benchmark: 'Référence Phase 1',
  ...
  of: 'Production',
  tests: 'Tests & comparaison',
  comparaison: 'Tests & comparaison',
  commercial: 'Commercial',
  ventes: 'Commercial',
  qualite: 'Qualité & reporting',
  qualité: 'Qualité & reporting',
  reporting: 'Qualité & reporting',
  zones: 'Qualité & reporting',
});
