...
const moduleLabel = (module = '') => ({ stock: 'Stock', finances: 'Finances', fournisseurs: 'Fournisseurs', tracabilite: 'Traçabilité', centre_decisionnel: 'Centre IA', ventes: 'Ventes', clients: 'Clients', avicole: 'Avicole', animaux: 'Animaux', sante: 'Santé', cultures: 'Cultures', alertes: 'Alertes', taches: 'Tâches', documents: 'Documents', investissements: 'Investissements', dashboard: 'Accueil', smartfarm: 'Smart Farm', comptabilite: 'Comptabilité' }[module] || module);
