...
export default function AssistantPanel({ open, onClose, dataMap, onNavigate }) {
  ...
  const [messages, setMessages] = useState([{ role: 'assistant', text: 'Assistant prêt. Dis “Hey Horizon” ou clique sur le soleil pour me réveiller. Je peux t’aider sur les ventes, encaissements, marges, stock, santé, avicole, tâches, documents et dossier partenaire.' }]);
