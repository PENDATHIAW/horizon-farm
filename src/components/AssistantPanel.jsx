...
export default function AssistantPanel({ open, onClose, dataMap, onNavigate }) {
  ...
  useEffect(() => {
    const handler = (event) => loadExternalDraft(event.detail?.draft, event.detail?.sourceLabel || 'Centre IA');
