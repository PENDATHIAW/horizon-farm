...
export default function Rapports(props) {
  ...
  return <div className="space-y-6 rapports-mobile-structured">
    ...
    <ModuleSection icon={FileText} title="Dossier financeur" subtitle="Choisir le Business Plan et le financeur cible avant de générer un PDF convaincant."><FinancingDossierGenerator data={props.data || {}} onCreateDocument={props.onCreateDocument} onRefreshDocuments={props.onRefreshDocuments} onCreateBusinessEvent={props.onCreateBusinessEvent} onRefreshBusinessEvents={props.onRefreshBusinessEvents} /></ModuleSection>
