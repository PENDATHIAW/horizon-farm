...
import { AlertTriangle, Calculator, CheckCircle2, RefreshCw, TrendingDown, TrendingUp } from 'lucide-react';
...
function needsUpdate(current = {}, enriched = {}) {
  ...
  if (Boolean(current.cout_a_completer) !== Boolean(enriched.cout_a_completer)) return true;
  if (Boolean(current.margin_reliable) !== Boolean(enriched.margin_reliable)) return true;
