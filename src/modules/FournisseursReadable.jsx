    ...
    <div className="fournisseurs-readable-order space-y-6">
      ...
      {hideEvolutionSection ? null : (
        <section className="rounded-3xl border border-line bg-white p-6 shadow-card space-y-4">
          <div>
            <p className="flex items-center gap-2 text-lg font-semibold text-earth">Évolution fournisseurs</p>
            <p className="mt-1 text-sm text-slate">Courbes et tendances placées en bas pour garder dettes, risques, commandes et fournisseurs prioritaires en haut.</p>
          </div>
