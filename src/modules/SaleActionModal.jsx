...
export default function SaleActionModal({ sale, payments, props, onClose, initialMode = 'edit', marginDetail = null }) {
  ...
  const save = async () => {
    ...
    const result = await workflowSubmit(`sale-action:${sale.id}:${mode}`, async () => {
