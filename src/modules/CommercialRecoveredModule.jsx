...
export default function CommercialRecoveredModule(props) {
  ...
  const data = useMemo(() => {
    ...
    return { orders, openOrders, receivable, clients, payments, toDeliver, toInvoice, openOpportunities: opportunities.filter(isOpportunityOpen) };
