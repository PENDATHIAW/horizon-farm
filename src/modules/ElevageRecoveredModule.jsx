        ...
        {findings.slice(0, 6).map((f) => (
          <div key={f.id} className="flex flex-col gap-2 rounded-2xl border border-amber-200 bg-amber-50 p-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex gap-2">
              <button type="button" onClick={() => onNavigate?.(f.module === 'achats_stock' ? 'achats_stock' : 'elevage')} className="rounded-lg border border-[#d6c3a0] bg-white px-2 py-1 text-xs font-black">Voir</button>
