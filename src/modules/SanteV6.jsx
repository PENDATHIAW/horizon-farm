...
const biosecurityMaterialOptions = [
  { value: 'fientes', label: 'Fientes' }, { value: 'fumier', label: 'Fumier' }, { value: 'litiere_usee', label: 'Litière usée' }, { value: 'melange', label: 'Mélange' },
];
const biosecurityStatusOptions = [
  { value: 'normal', label: 'Normal' }, { value: 'a_surveiller', label: 'À surveiller' }, { value: 'suspect', label: 'Suspect' }, { value: 'contamine', label: 'Contaminé' },
];
const biosecurityDestinationOptions = [
  { value: '', label: 'Non renseignée' }, { value: 'compostage', label: 'Compostage' }, { value: 'stockage', label: 'Stockage' }, { value: 'parcelle', label: 'Parcelle' }, { value: 'evacuation', label: 'Évacuation' },
];
...
const interventionPreset = (type) => ({
  ...
  biosecurite: { product: 'Nettoyage biosécurité', medicament: 'Désinfectant / chaux', voie: 'Pulvérisation / nettoyage', periodicite: 'hebdomadaire', evidence: 'Photo zone traitée', fields: ['batiment_box', 'zone_traitee', 'type_nettoyage', 'responsable', 'fumier_sacs', 'poids_estime_par_sac', 'biosecurity_material_type', 'biosecurity_status', 'biosecurity_destination', 'biosecurity_next_step', 'protocole', 'produits_nettoyage', 'eau_utilisee', 'duree_isolement'] },
