...
function MovementModal({ row, type, defaultQty = 1, saving, onClose, onConfirm }) {
  ...
  const impacts = [
    ...
    type === 'entree' && withFinance && amount > 0 ? 'Dépense finance et preuve/document attendus via le workflow achat.' : 'Aucune écriture finance manuelle forcée.',
  ];
  const confirm = () => {
