...
export default function AnimalSlaughterStockBridge({ rows = [], alimentationLogs = [], vaccins = [], businessEvents = [], onUpdate, onRefresh, onCreateBusinessEvent, onRefreshBusinessEvents }) {
  ...
  const submit = async (e) => {
    ...
    const totalCost = calculateAnimalCost({ animal, alimentationLogs, vaccins, healthEvents: businessEvents, directCharges: [...arr(businessEvents), payload], slaughterEvents: [...arr(businessEvents), payload] });
