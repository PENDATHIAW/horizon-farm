...
async function refreshRelated(props) {
  await Promise.allSettled([
    props.onRefresh?.(), props.onRefreshDocuments?.(), props.onRefreshAlertes?.(), props.onRefreshFinances?.(), props.onRefreshBusinessEvents?.(), props.onRefreshInvoices?.(), props.onRefreshPayments?.(), props.onRefreshOpportunities?.(),
  ]);
}
