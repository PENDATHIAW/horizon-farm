import { ClipboardList, RefreshCw, ShieldCheck, Wifi, WifiOff } from 'lucide-react';
...
export default function SyncERPModule({
  ...
  const auditCount = arr(auditLogsAll).length ? arr(auditLogsAll).length : arr(auditLogs).length;
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-3xl border border-[#d6c3a0] bg-white p-5 shadow-sm">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-[#8a7456]">Suivre l&apos;état de connexion, les actions en attente et les derniers événements de l&apos;ERP.</p>
      ...
      <div className="grid grid-cols-2 gap-3 xl:grid-cols-5">
        ...
        <Stat label="Logs" value={auditCount} />
      </div>
      <section className="rounded-3xl border border-[#d6c3a0] bg-white p-5 shadow-sm">
