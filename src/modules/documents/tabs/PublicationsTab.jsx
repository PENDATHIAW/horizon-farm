...
export default function PublicationsTab({ reports = [] }) {
  ...
  return (
    <section className="rounded-2xl border border-[#d6c3a0] bg-white p-5 shadow-sm">
      <h2 className="mb-1 flex items-center gap-2 font-black text-[#2f2415]"><Send size={19} /> Publications</h2>
      <p className="mb-4 text-sm text-[#8a7456]">Rapports gelés puis diffusés par un canal identifié.</p>
