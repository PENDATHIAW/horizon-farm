...
function Tabs({ active, onChange }) {
  const tabs = [['Résumé', ClipboardList], ['Alertes', Bell], ['Tâches', ListTodo], ['Traçabilité', GitBranch]];
...
export default function ActiviteSuiviRecoveredModule(props) {
  ...
  const data = useMemo(() => ({ openAlerts: alertes.filter(isOpen), openTasks: tasks.filter(isOpen), lateTasks: tasks.filter(isLate), events }), [alertes, tasks, events]);
