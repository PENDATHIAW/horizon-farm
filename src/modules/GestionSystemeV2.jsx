...
export default function GestionSystemeV2(props) {
  ...
  return <div className="space-y-6">
    <section className={`rounded-3xl border p-5 shadow-sm ${canManageSystem ? 'border-emerald-200 bg-emerald-50' : 'border-amber-200 bg-amber-50'}`}>
      ...
      <p className={`mt-1 text-sm ${canManageSystem ? 'text-emerald-800' : 'text-amber-800'}`}>Les permissions affichées guident l’interface. Les droits réels doivent rester confirmés côté serveur pour les données réelles.</p>
    </section>
