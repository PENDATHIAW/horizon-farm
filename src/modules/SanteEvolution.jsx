...
function ensure(map, key) { if (!map.has(key)) map.set(key, { key, mois: monthLabel(key), cout_vaccins: 0, cout_soins: 0, cout_biosecurite: 0, total_couts: 0, soins: 0, vaccins: 0, bios: 0, retards: 0, critiques: 0, cibles: 0, conformite: 0 }); return map.get(key); }
