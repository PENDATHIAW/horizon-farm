    ...
    <div className="space-y-5">
      {onOpenWorkflow ? (
        <section className="rounded-3xl border border-[#d6c3a0] bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-sm text-[#8a7456]">Soin, stock médicament, coût, rappel vaccin et délai sanitaire — une saisie.</p>
          <button type="button" onClick={() => onOpenWorkflow('health')} className="mt-3 rounded-xl bg-[#22c55e] px-4 py-2 text-sm font-black text-[#052e16]">+ Soin / vaccin</button>
        </section>
      ) : null}
