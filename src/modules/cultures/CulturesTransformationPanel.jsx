    ...
    <section className="rounded-3xl border border-[#d6c3a0] bg-white p-5 shadow-sm space-y-4">
      ...
      {!sourceStocks.length ? (
        ...
        <form onSubmit={submit} className="grid grid-cols-1 gap-3 md:grid-cols-6 xl:grid-cols-12 rounded-2xl border border-[#eadcc2] bg-[#fffdf8] p-4">
          ...
          <div className="md:col-span-1"><Field label="Unité"><input className={inputCls} value={form.unite_produit_fini} onChange={(e) => update('unite_produit_fini', e.target.value)} /></Field></div>
