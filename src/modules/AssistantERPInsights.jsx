...
function buildAssistantPriorities(dataMap = {}) {
  ...
  if (equipmentIssues.length) priorities.push({ module: 'equipe', tab: 'Parc Matériel & Maintenance', level: 'warning', badge: 'Matériel', title: `${equipmentIssues.length} équipement(s) en panne/maintenance`, description: 'Créer une tâche de maintenance et enregistrer les coûts éventuels.' });
