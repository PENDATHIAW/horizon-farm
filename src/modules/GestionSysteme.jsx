...
const MODULES = [
  ['dashboard', 'Dashboard'], ['assistant_erp', 'Assistant ERP'], ['centre_decisionnel', 'Centre décisionnel'], ['objectifs_croissance', 'Objectifs & Croissance'], ['animaux', 'Animaux'], ['avicole', 'Avicole'], ['sante', 'Santé & Vaccins'], ['finances', 'Finances'], ['comptabilite', 'Comptabilité'], ['investissements', 'Investissements'], ['impact_business', 'Impact & Valeur ERP'], ['stock', 'Stock'], ['clients', 'Clients'], ['ventes', 'Ventes'], ['fournisseurs', 'Fournisseurs'], ['tracabilite', 'Traçabilité'], ['alertes', 'Centre Alertes'], ['cultures', 'Cultures'], ['documents', 'Documents'], ['taches', 'Tâches'], ['rh', 'RH & Équipe'], ['rapports', 'Rapports'], ['equipements', 'Équipements'], ['smartfarm', 'Smart Farm'], ['audit_logs', 'Historique'], ['sync_activity', 'Activité & Sync ERP'], ['gestion_systeme', 'Gestion du système'],
];
...
const ROLE_HELP = {
  admin: 'Accès complet : gestion, données, finances, rôles et configuration.',
