...
export default function VentesV4(props) {
  ...
  return <div className="space-y-5 ventes-mobile-structured">
    <Section icon={CreditCard} title="Vendre & encaisser" subtitle="Créer une vente en une seule fois : client, produit, quantité, paiement, livraison et facture. L’ERP met à jour automatiquement finance, comptabilité, stock et historique client."><VentesTerrain {...props} /></Section>
