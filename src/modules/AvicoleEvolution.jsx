    ...
    {showChair ? <section className="space-y-4">
      <div className="bg-white border border-[#d6c3a0] rounded-2xl p-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-3 mt-4">
          ...
          <SmallMetric label="Coût sujet" value={fmtCurrency(avgChairCostLive)} hint="vivant/vendable" />
    ...
    {showPonte ? <section className="space-y-4">
      <div className="bg-white border border-[#d6c3a0] rounded-2xl p-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-3 mt-4">
          ...
          <SmallMetric label="Coût / œuf" value={fmtCurrency(avgPonteCostEgg)} hint="œuf vendable" />
