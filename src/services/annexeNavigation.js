...
const rules = [
  ...
  { pattern: /centre.*cycles|calendrier.*centre|fêtes du mois/i, module: 'centre_decisionnel', tab: 'Cycles', label: 'Centre → Cycles' },
  { pattern: /paramètres pilotage|pilotage|réglages/i, module: 'centre_decisionnel', tab: 'Annexe', label: 'Centre → Paramètres (bandeau pilotage)' },
