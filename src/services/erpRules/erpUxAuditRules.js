...
export function evaluateErpUxAuditRules() {
  ...
  const navOutsideVision = NAV_MODULE_ORDER.filter((id) => !visionSet.has(id) && id !== 'centre_ia' && id !== 'impact_business' && id !== 'cultures' && id !== 'equipements' && id !== 'smartfarm' && id !== 'sync_activity');
