...
export function composeDecisionDataMap({ crud = {}, dataMap = {}, liveMeteo = null } = {}) {
  return {
    ...
    deliveries: rows(crud.deliveries),
    invoices: rows(crud.invoices),
    ...
    sensors: rows(crud.sensor_devices),
    camera_devices: rows(crud.camera_devices),
    cameras: rows(crud.camera_devices),
