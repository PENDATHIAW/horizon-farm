...
export const DATA_SOURCES_OF_TRUTH = {
  sales_order: { table: 'sales_orders', modules: ['commercial', 'dashboard', 'centre_decisionnel', 'objectifs_croissance', 'clients', 'finance_pilotage', 'documents_rapports', 'assistant_erp'] },
  sales_order_item: { table: 'sales_order_items', modules: ['commercial', 'achats_stock', 'documents_rapports', 'elevage', 'cultures'] },
  payment: { table: 'payments', modules: ['commercial', 'finance_pilotage', 'clients', 'dashboard', 'centre_decisionnel'] },
  finance: { table: 'finances', modules: ['finance_pilotage', 'comptabilite', 'documents_rapports', 'objectifs_croissance'] },
  delivery: { table: 'deliveries', modules: ['commercial', 'clients', 'documents_rapports', 'centre_decisionnel'] },
  ...
  stock: { table: 'stock', modules: ['achats_stock', 'commercial', 'elevage', 'cultures', 'dashboard', 'centre_decisionnel'] },
  ...
  egg_production: { table: 'production_oeufs_logs', modules: ['elevage', 'avicole', 'dashboard', 'centre_decisionnel', 'documents_rapports', 'commercial'] },
  animal: { table: 'animaux', modules: ['elevage', 'sante', 'commercial', 'tracabilite', 'finance_pilotage'] },
  poultry_lot: { table: 'avicole', modules: ['elevage', 'commercial', 'centre_decisionnel', 'finance_pilotage'] },
  health: { table: 'sante', modules: ['elevage', 'sante', 'alertes', 'finance_pilotage'] },
  crop: { table: 'cultures', modules: ['cultures', 'commercial', 'finance_pilotage', 'achats_stock', 'documents_rapports', 'centre_decisionnel'] },
  ...
  irrigation: { table: 'business_events + sensor_devices', modules: ['cultures', 'smartfarm', 'finance_pilotage', 'centre_decisionnel', 'equipements'] },
  ...
  task: { table: 'taches', modules: ['activite_suivi', 'dashboard', 'centre_decisionnel', 'assistant_erp'] },
  alert: { table: 'alertes_center', modules: ['activite_suivi', 'dashboard', 'centre_decisionnel', 'assistant_erp'] },
  business_event: { table: 'business_events', modules: ['tracabilite', 'centre_decisionnel', 'documents_rapports', 'dashboard'] },
  equipment: { table: 'equipements', modules: ['equipements', 'finance_pilotage', 'smartfarm', 'activite_suivi'] },
  sensor: { table: 'sensor_devices', modules: ['smartfarm', 'equipements', 'cultures', 'elevage', 'centre_decisionnel'] },
  camera: { table: 'camera_devices', modules: ['smartfarm', 'equipements', 'centre_decisionnel'] },
  opportunity: { table: 'sales_opportunities', modules: ['commercial', 'objectifs_croissance', 'centre_decisionnel'] },
  ...
  ai_recommendation: { table: 'ai_recommendations', modules: ['assistant_erp', 'centre_decisionnel'] },
};
